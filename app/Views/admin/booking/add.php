                                ...
                                <div id="formControls" class="mb-5">
                                    <div class="card">
                                        <div class="card-body pb-2">
                                            <form method="post" action="<?= base_url('admin/booking/addProcess') ?>" enctype="multipart/form-data">
                                                <div class="row">
                                                    <div class="col-xl-6">
                                                    ...
                                                    <div class="col-xl-6">
                                                        ...
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <input type="file" name="booking_proof_of_payment" required class="form-control" id="exampleFormControlFile1" />
                                                        </div>
                                                    </div>
                                                </div><br>
                                                <div>
